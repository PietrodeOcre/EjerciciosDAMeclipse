...
public class EscribirYLeer
{
    ...
    public static void main(String[] args)
    {
        ...
        eyl.escribeFichero("/home/pietrodeocre/Documentos/gradomedio/GradoSuperior/PROG/Tema11/archivosficheros/mascotas.txt");
        eyl.anhadeFichero("/home/pietrodeocre/Documentos/gradomedio/GradoSuperior/PROG/Tema11/archivosficheros/mascotas.txt");
        eyl.leeFichero("/home/pietrodeocre/Documentos/gradomedio/GradoSuperior/PROG/Tema11/archivosficheros/mascotas.txt");
    }
    ...
    public void escribeFichero(String fichero)
    {
        try
        {
            ...
            for (int i = 0; i <5; i++)
            {
                ...
                // del bucle.
            	Brazo brazo= new Brazo("iz","der");
                Persona p = new Persona("nombre","apellido",brazo);
                oos.writeObject(p);
            }
            oos.close();
        } catch (Exception e)
    ...
    public void anhadeFichero (String fichero)
    {
        try
        {
            ...
            for (int i = 5; i < 10; i++)
            {
                p.setPersona("nombre","apellido",brazo);   // Se rellenan los datos de Persona.
                oos.writeUnshared(p);
            }
            oos.close();
        } catch (Exception e)
